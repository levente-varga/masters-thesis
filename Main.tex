...
\newcommand{\researchQuestionOne}{Which genres of games can be extracted and combined to create a new game type?}
\newcommand{\researchQuestionTwo}{What implications can be derived by implementing a game based on a combination of specific game genres?}
